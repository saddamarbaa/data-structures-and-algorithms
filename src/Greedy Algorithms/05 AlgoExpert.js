/* Minimum Waiting Time
 ...
 Prompt: 
 You're given a non-empty array of positive integers representing the amounts of time that specifies 'queries' take to execute. 
 ...
 For example, if you are given the queries of durations [ 1, 4, 5], then the total waiting time if the queries were 
 executed in the order of [5, 1, 4] would be: (0) + (5) + (5+1) =11.
