...
similar to the way we play card game.we split The array into 2 part
a sorted part and an unsorted part.
we pick value from unsorted part and placed into it right place in sorted part

  How Insertion Sort Works?

(1) we assume The first element in the array is sorted.
(2) Start iterating over the array to be sorted from second element
   until end of the array.
(3) Take the second element and store it separately in temp variable
...
(6) Repeat  step number 5 until all array is sorted.
